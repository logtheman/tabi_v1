			...
			<div>
				<form>
				  ...
				  <div className="form-group">
				    ...
				    <input type="text" className="form-control" id="URL" placeholder="" />
				  </div>

	  	    <div className="row mb-2">
	  				<div className="col-3 form-group">
	  					<label className="" htmlFor="from">From: </label>
	  			  	<input type="time" className="form-control travel-date-inputs"  id="from" placeholder=""/>
	  			  </div>
	  			  <div className="col-3 form-group">
	  					<label className="" htmlFor="to">To:</label>
	  	  	  	<input type="time" className="form-control travel-date-inputs" id="to" placeholder="" />
	  	  	  </div>
	    	  </div>
	    	  <div className="row">
	    	  	<div className="ml-2 btn-group form-group" role="group" aria-label="Basic example">
	    	  		Price Range:
							...
							<label className="custom-control custom-radio">
							  <input id="radio3" name="radio" type="radio" className="custom-control-input" />
							  <span className="custom-control-indicator"></span>
							  <span className="custom-control-description">$$$</span>
							</label>
							<label className="custom-control custom-radio">
							  <input id="radio4" name="radio" type="radio" className="custom-control-input" />
							  <span className="custom-control-indicator"></span>
							  <span className="custom-control-description">$$$$</span>
							</label>
  	    	  </div>
	    	  ...
	    	  <div className="form-group">
	    	    ...
	    	    <input type="text" className="form-control" id="notes" placeholder="" />
	    	  </div>
	    	  <Modal.Footer>
